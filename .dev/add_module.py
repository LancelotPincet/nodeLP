...
def main() :
    ...
    def copy_file(from_path, to_path) :
        ...
        string = string.replace('template_modulelib', "nodeLP")
        string = string.replace('template_modulelowerlib', "nodelp")
        string = string.replace('template_moduleequals', "="*len(name))
        string = string.replace('template_modlibeq', "="*len("nodeLP"))
    ...
    modjson['date'] = date
    json_path = path.parent / f'libsLP/nodeLP/src/nodelp/modules.json'
    ...
    allmodules_path = path.parent / f'libsLP/nodeLP/docs/source/modules.rst'
