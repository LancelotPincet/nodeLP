...
To finish, some scripts may be provided with the library **nodeLP** :doc:`(see Reference Guide) <scripts>`.
To use them, you can just download `scripts source codes <https://github.com/LancelotPincet/nodeLP/tree/main/src/nodelp/scripts>`_.
